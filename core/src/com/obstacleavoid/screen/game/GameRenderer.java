...
public class GameRenderer implements Disposable {
    ...
    //== constructors ==
    public GameRenderer(SpriteBatch batch, GameController controller, AssetManager assetManager) {
    ...
    private void renderGameplay() {
        ...
        for(Obstacle obstacle : gameController.getObstacles2()) {
            batch.draw(obstacleRegion,
                   obstacle.getX(), obstacle.getY(),
                    obstacle.getWidth(), obstacle.getHeight());
        }
    ...
    private void renderUi() {
        ...
        String livesText = "LIVES: " + gameController.lives;
    ...
    private void drawDebug() {
        ...
        Array<Obstacle> obstacles2 = gameController.getObstacles2();
